  ...
  return (
    ...
    >
      ...
      <p className="mb-10 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Keep up to date with the latest news, trends, and insights from us and our partners. We'll send you a monthly newsletter with the most important updates and insights.
      </p>
      <div>
        <input
          type="text"
